...
var PumaConverter = {
    ...
    identifyProduct: function(title, handle) {
        return (typeof CatalogClient !== 'undefined' && CatalogClient.modelFromTitle)
            ? CatalogClient.modelFromTitle(title, 'Puma') : null;
    },
    ...
    existingHandles: {
        ...
        'puma-mens-deviate-nitro-3-glowing-red-mint-melt': 'mens-deviate-nitro-3-glowing-red-mint-melt',
        'puma-mens-deviate-nitro-3-glowing-red-puma-black': 'mens-deviate-nitro-3-glowing-red-puma-black',
        'puma-mens-deviate-nitro-3-glowing-red-puma-white': 'mens-deviate-nitro-3-glowing-red-puma-white',
        ...
        'puma-mens-deviate-nitro-3-sun-stream-sunset-glow-puma-white': 'mens-deviate-nitro-3-sun-stream-sunset-glow-puma-white',
        ...
        'puma-mens-magnify-nitro-3-puma-black-sunny-lime': 'mens-magnify-nitro-3-puma-black-sunny-lime',
        'puma-mens-magnify-nitro-3-puma-white-warm-white': 'mens-magnify-nitro-3-puma-white-warm-white',
        'puma-mens-magnify-nitro-3-zen-blue-gray-echo': 'mens-magnify-nitro-3-zen-blue-gray-echo',
        'puma-mens-velocity-nitro-4-heat-fire-puma-black': 'mens-velocity-nitro-4-heat-fire-puma-black',
        'puma-mens-velocity-nitro-4-puma-black': 'mens-velocity-nitro-4-puma-black',
        'puma-mens-velocity-nitro-4-puma-black-dark-amethyst': 'mens-velocity-nitro-4-puma-black-dark-amethyst',
        'puma-mens-velocity-nitro-4-puma-black-puma-silver': 'mens-velocity-nitro-4-puma-black-puma-silver',
        'puma-mens-velocity-nitro-4-puma-white-lux-lime': 'mens-velocity-nitro-4-puma-white-lux-lime',
        'puma-mens-velocity-nitro-4-puma-white-mint-melt-glowing-red': 'mens-velocity-nitro-4-puma-white-mint-melt-glowing-red',
        'puma-mens-velocity-nitro-4-puma-white-puma-black': 'mens-velocity-nitro-4-puma-white-puma-black',
        'puma-mens-velocity-nitro-4-puma-white-ultra-blue-poison-pink': 'mens-velocity-nitro-4-puma-white-ultra-blue-poison-pink',
        'puma-mens-velocity-nitro-4-sandstone-lucite': 'mens-velocity-nitro-4-sandstone-lucite',
        'puma-mens-velocity-nitro-4-sea-glass-mint-melt': 'mens-velocity-nitro-4-sea-glass-mint-melt',
        'puma-mens-velocity-nitro-4-sea-glass-speed-blue': 'mens-velocity-nitro-4-sea-glass-speed-blue',
        'puma-mens-velocity-nitro-4-speed-blue-gold-moon': 'mens-velocity-nitro-4-speed-blue-gold-moon',
        'puma-womens-deviate-nitro-3-cool-light-gray-new-navy': 'womens-deviate-nitro-3-cool-light-gray-new-navy',
        'puma-womens-deviate-nitro-3-gold-moon-alpine-snow': 'womens-deviate-nitro-3-gold-moon-alpine-snow',
        'puma-womens-deviate-nitro-3-mint-melt-glowing-red': 'womens-deviate-nitro-3-mint-melt-glowing-red',
        'puma-womens-deviate-nitro-3-mint-melt-speed-blue': 'womens-deviate-nitro-3-mint-melt-speed-blue',
        'puma-womens-deviate-nitro-3-nitro-blue-fizzy-apple': 'womens-deviate-nitro-3-nitro-blue-fizzy-apple',
        'puma-womens-deviate-nitro-3-pale-plum-midnight-plum-sun-stream': 'womens-deviate-nitro-3-pale-plum-midnight-plum-sun-stream',
        'puma-womens-deviate-nitro-3-peaceful-blue-glowing-red': 'womens-deviate-nitro-3-peaceful-blue-glowing-red',
        'puma-womens-deviate-nitro-3-puma-black-fluro-pink-pes': 'womens-deviate-nitro-3-puma-black-fluro-pink-pes',
        'puma-womens-deviate-nitro-3-puma-black-puma-white-puma-silver': 'womens-deviate-nitro-3-puma-black-puma-white-puma-silver',
        'puma-womens-deviate-nitro-3-puma-black-sunset-glow-sun-stream': 'womens-deviate-nitro-3-puma-black-sunset-glow-sun-stream',
        'puma-womens-deviate-nitro-3-puma-white-glowing-red': 'womens-deviate-nitro-3-puma-white-glowing-red',
        'puma-womens-deviate-nitro-3-puma-white-glowing-red-mint-melt': 'womens-deviate-nitro-3-puma-white-glowing-red-mint-melt',
        'puma-womens-deviate-nitro-3-puma-white-mint-melt': 'womens-deviate-nitro-3-puma-white-mint-melt',
        'puma-womens-deviate-nitro-3-rose-mauve-new-navy': 'womens-deviate-nitro-3-rose-mauve-new-navy',
        'puma-womens-deviate-nitro-3-sun-stream-sunset-glow-puma-white': 'womens-deviate-nitro-3-sun-stream-sunset-glow-puma-white',
        'puma-womens-deviate-nitro-3-yellow-alert-puma-silver': 'womens-deviate-nitro-3-yellow-alert-puma-silver',
        'puma-womens-deviate-nitro-4-apple-spritz-lux-lime': 'womens-deviate-nitro-4-apple-spritz-lux-lime',
        'puma-womens-deviate-nitro-4-intense-mint-light-lavender': 'womens-deviate-nitro-4-intense-mint-light-lavender',
        'puma-womens-deviate-nitro-4-light-lavender-inky-depths': 'womens-deviate-nitro-4-light-lavender-inky-depths',
        'puma-womens-deviate-nitro-4-puma-black-puma-white-puma-silver': 'womens-deviate-nitro-4-puma-black-puma-white-puma-silver',
        'puma-womens-deviate-nitro-4-puma-white-feather-gray': 'womens-deviate-nitro-4-puma-white-feather-gray',
        'puma-womens-deviate-nitro-4-puma-white-light-lavender': 'womens-deviate-nitro-4-puma-white-light-lavender',
        'puma-womens-deviate-nitro-4-puma-white-poison-pink-glowing-red': 'womens-deviate-nitro-4-puma-white-poison-pink-glowing-red',
        'puma-womens-deviate-nitro-4-pure-pink-puma-white': 'womens-deviate-nitro-4-pure-pink-puma-white',
        'puma-womens-deviate-nitro-4-sunny-lime-puma-silver': 'womens-deviate-nitro-4-sunny-lime-puma-silver',
        'puma-womens-deviate-nitro-4-ultra-red-puma-silver': 'womens-deviate-nitro-4-ultra-red-puma-silver',
        'puma-womens-deviate-nitro-4-warm-white-lucite-vapor-gray': 'womens-deviate-nitro-4-warm-white-lucite-vapor-gray',
        'puma-womens-magmax-cool-weather-puma-silver': 'womens-magmax-cool-weather-puma-silver',
        'puma-womens-magmax-lux-army-warm-white-dusky-gray': 'womens-magmax-lux-army-warm-white-dusky-gray',
        'puma-womens-magmax-mint-melt-speed-blue': 'womens-magmax-mint-melt-speed-blue',
        'puma-womens-magmax-nitro-2-puma-black-puma-white': 'womens-magmax-nitro-2-puma-black-puma-white',
        'puma-womens-magmax-nitro-2-puma-white-puma-silver': 'womens-magmax-nitro-2-puma-white-puma-silver',
        'puma-womens-magmax-nitro-2-puma-white-ultra-blue-poison-pink': 'womens-magmax-nitro-2-puma-white-ultra-blue-poison-pink',
        'puma-womens-magmax-nitro-2-silver-mist-apple-spritz': 'womens-magmax-nitro-2-silver-mist-apple-spritz',
        'puma-womens-magmax-nitro-2-warm-white-puma-black': 'womens-magmax-nitro-2-warm-white-puma-black',
        'puma-womens-magmax-peaceful-blue-yellow-alert': 'womens-magmax-peaceful-blue-yellow-alert',
        'puma-womens-magmax-puma-black-dark-amethyst': 'womens-magmax-puma-black-dark-amethyst',
        'puma-womens-magmax-puma-black-lime-shimmer-green-lux': 'womens-magmax-puma-black-lime-shimmer-green-lux',
        'puma-womens-magmax-puma-black-puma-white': 'womens-magmax-puma-black-puma-white',
        'puma-womens-magmax-puma-white-puma-silver': 'womens-magmax-puma-white-puma-silver',
        'puma-womens-magmax-puma-white-ultra-blue-poison-pink': 'womens-magmax-puma-white-ultra-blue-poison-pink',
        'puma-womens-magmax-silver-mist-apple-spritz': 'womens-magmax-silver-mist-apple-spritz',
        'puma-womens-magmax-warm-white-lucite': 'womens-magmax-warm-white-lucite',
        'puma-womens-magmax-warm-white-puma-black': 'womens-magmax-warm-white-puma-black',
        'puma-womens-magnify-nitro-3-apple-spritz-lux-lime': 'womens-magnify-nitro-3-apple-spritz-lux-lime',
        'puma-womens-magnify-nitro-3-lilac-crush-sage-frost': 'womens-magnify-nitro-3-lilac-crush-sage-frost',
        'puma-womens-magnify-nitro-3-misty-pink-rose-gold': 'womens-magnify-nitro-3-misty-pink-rose-gold',
        'puma-womens-magnify-nitro-3-puma-black-mint-melt': 'womens-magnify-nitro-3-puma-black-mint-melt',
        'puma-womens-magnify-nitro-3-puma-black-puma-white': 'womens-magnify-nitro-3-puma-black-puma-white',
        'puma-womens-magnify-nitro-3-puma-white-puma-silver': 'womens-magnify-nitro-3-puma-white-puma-silver',
        'puma-womens-magnify-nitro-3-sea-glass-mint-melt': 'womens-magnify-nitro-3-sea-glass-mint-melt',
        'puma-womens-velocity-nitro-4-apple-spritz-deep-plum': 'womens-velocity-nitro-4-apple-spritz-deep-plum',
        'puma-womens-velocity-nitro-4-dark-amethyst-puma-black': 'womens-velocity-nitro-4-dark-amethyst-puma-black',
        'puma-womens-velocity-nitro-4-deep-plum-apple-spritz': 'womens-velocity-nitro-4-deep-plum-apple-spritz',
        'puma-womens-velocity-nitro-4-fresh-water-puma-white': 'womens-velocity-nitro-4-fresh-water-puma-white',
        'puma-womens-velocity-nitro-4-lilac-crush-sage-frost': 'womens-velocity-nitro-4-lilac-crush-sage-frost',
        'puma-womens-velocity-nitro-4-mint-melt-speed-blue': 'womens-velocity-nitro-4-mint-melt-speed-blue',
        'puma-womens-velocity-nitro-4-puma-black-dark-amethyst': 'womens-velocity-nitro-4-puma-black-dark-amethyst',
        'puma-womens-velocity-nitro-4-puma-black-puma-white': 'womens-velocity-nitro-4-puma-black-puma-white',
        'puma-womens-velocity-nitro-4-puma-white-glowing-red-poison-pink': 'womens-velocity-nitro-4-puma-white-glowing-red-poison-pink',
        'puma-womens-velocity-nitro-4-puma-white-mint-melt-glowing-red': 'womens-velocity-nitro-4-puma-white-mint-melt-glowing-red',
        'puma-womens-velocity-nitro-4-puma-white-puma-black': 'womens-velocity-nitro-4-puma-white-puma-black',
        'puma-womens-velocity-nitro-4-sea-glass-gold-moon': 'womens-velocity-nitro-4-sea-glass-gold-moon',
        'puma-womens-velocity-nitro-4-warm-white-lucite': 'womens-velocity-nitro-4-warm-white-lucite',
    },
