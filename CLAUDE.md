...
only be harvested per product. ON serves product imagery from Contentful, whose
asset ids are opaque. Hoka was not resolved: hoka.com blocks scripted requests
and geo-redirects.
